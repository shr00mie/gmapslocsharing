...
class CookieMonster:
    ...
    def file_check(self):
        ...
        try:
            if cookie.exists():
                ...
                log.warning('Cookie file does not exist.')
        except Exception as e:
            log.debug('File Check Failed - {}.'.format(e))
    ...
    def browser_login(self):
        ...
        try:
            ...
            log.debug('Launching {}'.format(self.config['login_start']))
    ...
    def check(self):
        ...
        log.info('Checking for cookie existence & validity.')
