...
class Location:
    ...
    def clean_data(self):
        ...
        log.debug('Clean Data - Parsing raw location data.')
                    ...
                    try:
                        ...
                        if i == 8:
                            ...
                            if len(line[0].split()) > 1:
                                people[p].update({'first_name': line[0].split()[0]})
                            else:
                                people[p].update({'first_name': line[0]})
                        elif i == 22:
        ...
        log.debug('Dropping {} people due to bad data.'.format(len(rm)))
        for x in rm:
            del people[x]
    ...
    def create_people(self):
        ...
        try:
            ...
            log.debug('Create People - Clearing previously stored data.')
            self.people = []
    ...
    def update(self):
        ...
        log.info('Updating location sharing data.')
        try:
            ...
            if self.query_data():
                ...
                if self.clean_data():
                    ...
                    if self.create_people():
                        log.info('Updated location data for {} people.'.format(len(self.clean_people)))
        except Exception as e:
